CREATE VIEW dbo.ContratistasVista
AS
SELECT        dbo.PersonaTable.PersonaId, dbo.PersonaTable.PersonaNombre, dbo.PersonaTable.PersonaApellido, dbo.PersonaTable.PersonaDocumento, dbo.PersonaTable.PersonaTelefono, 
                         ...
                         dbo.ServicioContratistaTable.ServicioContratistaNombre
FROM            dbo.PersonaTable INNER JOIN
                         dbo.ServicioContratistaTable ON dbo.PersonaTable.PersonaServicio = dbo.ServicioContratistaTable.ServicioContratistaId
WHERE        (dbo.PersonaTable.PersonaTipoId = 5) AND (dbo.PersonaTable.PersonaActivo = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'ContratistasVista';
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "PersonaTable"
            ...
            TopColumn = 12
         End
         Begin Table = "ServicioContratistaTable"
            Begin Extent = 
               Top = 27
               Left = 355
               Bottom = 140
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'ContratistasVista';
