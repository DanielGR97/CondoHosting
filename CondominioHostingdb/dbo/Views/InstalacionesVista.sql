CREATE VIEW dbo.[InstalacionesVista]
AS
...
WHERE        (dbo.InstalacionTable.InstalacionActivo = 1)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'InstalacionesVista';
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "InstalacionTable"
            ...
            TopColumn = 0
         End
         Begin Table = "TipoInstalacionTable"
            Begin Extent = 
               Top = 123
               Left = 305
               Bottom = 236
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'InstalacionesVista';
